...
class dates_normal extends CalDate {
    ...
    public $datenCols = array("{CAL_DATE}","{CAL_TITLE}","{CAL_TEXT}","{CAL_ORT}");
    ...
    function admin_init() {
        ...
        $this->adminTemplate = '<table class="cal-admin-event {COLOR}" cellspacing="0" border="0" cellpadding="0"><tbody>'
            ...
            .'</tr><tr>'
                ...
                .'<td colspan="3">{CAL_TITLE}</td>'
            .'</tr><tr>'
                .'<td colspan="4">'.$this->language->getLanguageValue("cal_inhalt").'<br />'
                .'{CAL_TEXT}</td>'
            .'</tr>'
        .'</tbody></table>';
    }
