...
// erweiterungen von mir
// die tr mit der class ".sorting-hide" wird gehiden wenn der sorttype nicht "caldate" ist
// sortmetode "caldate" erstelt die trs mit monats titel berücksichtigt
// optional "sorting" class hinzufügen wegen den sort symbol
...
// das sort array immer neu erstellen damit die tr mit dem monat immer oben ist
if(type == "caldate") {
    // das tr mit dem monat zeigen
     $(".sorting-hide").show(0);
    reverse_column = false;
    stupidtable_asc = sort_dir;
}  else
     $(".sorting-hide").hide(0);
